    ...
    sections: [
      {
        children: [
          ...
          new Paragraph(`Skills: ${resume.skills || ""}`),
          ...(resume.technologies
            ? [new Paragraph(`Technologies: ${resume.technologies}`)]
            : []),
          ...(resume.libraries
            ? [new Paragraph(`Libraries & Frameworks: ${resume.libraries}`)]
            : []),
          ...(resume.softSkills
            ? [new Paragraph(`Soft Skills: ${resume.softSkills}`)]
            : []),
